...
test("deep analysis payload merges oracle data and AI structured sections", () => {
  const payload = buildDeepAnalysisPayload(
    {
      financials: [{ date: "2026-03-31", revenue: 1000, free_cash_flow: 120, fcf_margin: 0.12 }],
      balance_sheet: { cash: 500, total_debt: 250, debt_to_equity: 0.25 },
      weekly_technicals: { close: 300, ema200: 200, ma50: 250, ema20: 280, golden_filter_pass: true },
      daily_technicals: { close: 300, pullback_active: false, zvr_ratio: 1.4, rsi_14: 48.2 },
