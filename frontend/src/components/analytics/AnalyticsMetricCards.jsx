...
export function AnalyticsMetricCards({ stats }) {
  return (
    <section
      className="[display:grid] [grid-template-columns:repeat(auto-fit,_minmax(180px,_1fr))] [gap:12px] max-[1100px]:[grid-template-columns:repeat(auto-fit,_minmax(150px,_1fr))]"
      aria-label="Analytics KPI cards"
    >
